...
def merge_name_record(record1, record2):
    #print "record1: " + str(len(record1))
    #print "record2: " + str(len(record2))
    result = []
...
def merge_name(name1, name1_norm, name2, name2_norm):
    #print name1_norm.first()
    #print name2_norm.first()
    #print (name1_norm.first() == name2_norm.first() or name1_norm.first()[0][0] == name2_norm.first()[0][0])
    #print (name1_norm.middle() == name2_norm.middle() or name1_norm.middle()[0][0] == name2_norm.middle()[0][0])
    #print name1_norm.last() == name2_norm.last()
    #print name1_norm.prelast() == name2_norm.prelast()
    if (name1_norm.first() == name2_norm.first() or name1_norm.first()[0][0] == name2_norm.first()[0][0]) and \
        ...
        #print "merge_name result: " + str(result)
    else:
        return -1
...
def merge_author(author1, author1_norm, author2, author2_norm):
    ...
    #print authors2
    #print authors2_norm
    #print len(authors1), len(authors1_norm), len(authors2), len(authors2_norm)
    ...
    for i, author1 in enumerate(authors1):
        for j, author2 in enumerate(authors2):
            #print "merge_ author: " + str(author1) + " & " + str(author2)
            result = merge_names(author1, authors1_norm[i], author2, authors2_norm[j])
            if result != -1:
               merged.append(result) 
            #print "merge_author merged: " + str(merged)
